...
const Dashboard = () => {
  ...
  const columns = [
      ...
      flex: 1,},
    {
      ...
      headerName: "Amount",
      flex: 1,
      renderCell: (params) => `${USDollar.format(params.value)}`,
    },
  ];
    ...
    <Box m="1.5rem 2.5rem">
      ...
      >
        ...
        <StatBox
          ...
          value={data && data.predicts.length}
          // increase="+43%"
          // description="Since last month"
          icon={
            <Traffic
        ...
        >
          ...
          >
            Breakdown of probability of default predictions for all the loan profiles created.
          </Typography>
        </Box>
      </Box> 
    </Box>
